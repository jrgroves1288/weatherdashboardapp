...
// main card
function getData() {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=b2e85468d052227d066392ecc1d8e971"
    mainCard.empty();
    $("#weeklyForcast").empty();
    // requests
    $.ajax({
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/uvi?appid=b2e85468d052227d066392ecc1d8e971&lat=" + lat + "&lon=" + lon,
            method: "GET"
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=b2e85468d052227d066392ecc1d8e971",
            method: "GET"
